...
parser.add_argument("input_rna_path", type=str, help="Path to the RNA h5ad file." )
parser.add_argument("input_atac_path", type=str, help="Path to the ATAC h5ad file.")
parser.add_argument("output_path", type=str, help="Directory where per-donor h5ad files and summary files will be saved.")
...
if not list_donors_information:
    print("ERROR: No paired donors found.")
    exit(1)
