...
if not file_paths:
    raise FileNotFoundError(f"No *_RNA_multiome_subset.h5ad files found in {args.input_folder}")
print(f"Found {len(file_paths)} donor files")
